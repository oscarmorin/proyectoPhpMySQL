...
<head>
	...
	<title>Atletic WEB | Ingresar Disciplinas</title>
...
<header>
    ...
    <section id="Formulario">
        ...
        <div id="titulo">
            ...
            <h2>Ingresar Nuevas Disciplinas</h2>

        </div>

        <form id="Registrarse" action="NuDis.php" name="Registrarse" method="POST">
            ...
            <div id="Form">
               ...
               <input type="text" id="ID" name="Dis" placeholder="Ingrese nueva disciplina">

               </table>

               <div id="botones2">

                <input type="button" value="Añadir" id="boton" name="mod" onclick="MoDis();">
