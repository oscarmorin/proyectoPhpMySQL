...
<header>
    ...
    <section id="Formulario">
        ...
        <form id="Registrarse" action="ModificarP.php" name="Registrarse" method="POST">
                ...
                echo "No puede estar vacio";
                    ...
                    if (mysqli_num_rows($resultado)==0) {
                        ...
                        if ($estado == "I"){
                          ...
                          echo "Persona Inactiva...!!! No se puede modificar.";
                          $id="";
...
?>
                   ...
                   <tr id="tab">
                   <td id="tab">
                       <input type="text" id="idr" name="idr" readonly="true"
                       <?php
                        echo "value='$id'";  
                        ?>
                        />
                   ...
                   <td id="tab">
                       <input type="text" id="Nom" name="Nom" required <?php
                       echo "value='$nombre'";
                       ?>/>
                       
                   </td>
                   <td id="tab">
                       <input type="number" id="Edad" name="Edad" required <?php
                       echo "value='$edad'";
                       ?>/>
                   </td>
                   <td id="tab">
                ...
                <div id="botones2">
                <input type="button" value="Modificar" id="boton" name="mod" onclick="Act();">
                <input type="button" value="Regresar" id="boton" name="can" onclick="Md();">
                </div>
