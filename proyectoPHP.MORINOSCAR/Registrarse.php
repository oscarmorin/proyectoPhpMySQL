...
<head>
	...
	<title>Atletic WEB | Registrarse</title>
...
<header>
    ...
    <section id="Formulario">
        ...
        <form id="Registrarse" action="Registro.php" name="Registrarse" method="POST">

            <div id="Form">
               
               <label for="name">Nombre Completo</label> 
               <input type="text" id="name" name="Nom" placeholder="Nombre Completo" required>
                ...
                <select id="disciplina" name="id" placeholder="Disciplina" required>
                    <option selected="value" disabled="">Selecciona una opción</option>
                    <?php
                ...
                <input type="submit" value="Enviar Registro" id="Send" name="Send" onclick="CheckForm();">
            </div>
