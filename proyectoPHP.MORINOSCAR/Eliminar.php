...
<head>
	...
	<title>Atletic WEB | Baja - Alta</title>
...
<header>
    ...
    <section id="Formulario">
        ...
        <form id="Registrarse" action="EliminarP.php" name="Registrarse" method="POST">

            <div id="Form">
               
               <table id="table">

               <label for="ID">ID Atleta</label> 
               <input type="text" id="ID" name="ID" placeholder="ID Atleta">

               </table>

               <div id="botones2">

                <input type="button" value="Buscar" id="boton" name="bus" onclick="Bus ();">
                <input type="button" value="Cancelar" id="boton" name="can" onclick="Atletas ();">
