...
<head>
	...
	<title>Atletic WEB | Atletas</title>
        ...
        <div id="titulo">          
            ...
            <div id="Form">
               ...
               <div id="botones3">
                ...
                <input type="button" value="Ingresar" id="boton" name="ing" onclick="Ingresar();">
                <input type="button" value="Modificar" id="boton" name="modi" onclick="Modificar();">
                <input type="button" value="Alta | Baja" id="boton" name="eli" onclick="Eliminar();">
